...
def main():
    ...
    parser.add_argument('--enable-translation', action='store_true', help='Enable translation', default=False)
    parser.add_argument('--target-language', default='cn', help='Target language for translation')
